...
<div class="modal-body">
    ...
    <div class="input-group mb-3">
        <input type="text" class="form-control number" id="produto_codigo" maxlenght="11" name="produto_codigo" placeholder="Código de barras" onchange="verificaCodigo('produto_codigo')" required>
