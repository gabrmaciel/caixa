                ...
                if ($result->num_rows > 0) {
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="width:20%" class="pt-3">R$ <?php echo $preco?></td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="input-group mb-3">
                    <input type="text" class="form-control number" id="produto_codigo" name="produto_codigo" placeholder="Código de barras" onchange="verificaCodigo('produto_codigo')" required autofocus>
