                    ...
                    <div class="table-corpo" id="tabela-linha">
                        ...
                        for($i = 1; $i <= 8; $i++){
                            ...
                            <div class="tabela-linha-div" id="tabela-linha-div<?php echo $i?>">
                                <input type="text" class="tabela-input p-2 tabela-linha" <?php if($i == 1){ echo "autofocus";}?> id="tabela-input<?php echo $i ?>" name="tabela-input<?php echo $i ?>" onkeyup="enterValor(event, <?php echo $i ?>)" maxlength="20">
                            </div>
                            <?php
                        }
                        ?>
                        ...
                        for($i = 1; $i <= 8; $i++){
                            ...
                            <div class="tabela-linha col-12" id="tabela-produtos-linha<?php echo $i ?>">
                                <div class="row pt-2 pb-2">
                                    ...
                                    <div class="col-2">
                                        <input type="text" class="input-transparente text-right tabela-listagem-preco" id="tabela-listagem-preco<?php echo $i ?>" disabled>
                                    </div>
                                </div>
                            </div>
                            <?php
    ...
    <div class="col-3">
        ...
        <div class="mt-4">
            ...
            <div class="tabela-preco col-12 font-weight-bold">
                <input type="text" class="preco-valor preco-valor-input text-right px-3 pt-2 pb-2 money" id="preco-pagamento" value="0,00" maxlength="8">
            </div>
